...
Phenotypic anti-tuberculosis activity prediction
...
Before running the training script, please check and modify the paths in scripts/train.py, especially:
...
These files are saved in the output directory defined by config["OUT_DIR"].
